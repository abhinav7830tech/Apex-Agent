                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-500">
                      Sign up to get started with Apex Agent
                    </p>
                  </div>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative group">
                              <User className="absolute left-3.5 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-green-600 transition-colors" />
                              <Input
                                type="text"
