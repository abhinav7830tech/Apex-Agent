...
export const notificationType = pgEnum("notification_type", ['meeting_reminder', 'meeting_started', 'meeting_ended', 'meeting_cancelled', 'summary_ready'])
...
export const meetings = pgTable("meetings", {
	...
	sentiment: text(),
	talkTimePerUser: text("talk_time_per_user"),
}, (table) => [
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
